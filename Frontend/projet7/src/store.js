export default {
  articles: [
    {
      name: "Rencontre avec les délégués syndicaux",
      slug: "Rencontre avec les délégués syndicaux",
      image: "brazil.jpg",
      id: 1,
      description:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus eu quam magna. Pellentesque sed dui tempus lectus vehicula mollis. Sed non enim et lorem dapibus tincidunt et a magna. Pellentesque id magna magna. Ut porttitor diam sed erat lobortis, eget pellentesque est ornare. Ut vitae magna imperdiet, scelerisque enim eu, ullamcorper sapien. Aliquam imperdiet libero non orci ultrices aliquam. Nunc dictum libero rutrum nisl tincidunt iaculis. Nullam egestas nunc lacus, finibus placerat ipsum porttitor vitae. Nulla placerat scelerisque erat, ut accumsan urna volutpat aliquam.",
      experiences: [
        {
          name: "Iguaçu Falls",
          slug: "iguacu-falls",
    ...
    {
      name: "Interview avec le PDG",
      slug: "Interview avec le PDG",
      image: "hawaii.jpg",
      id: 3,
      description:
        "Etiam iaculis, ex in semper fringilla, lorem augue maximus lorem, in aliquet ex massa non enim. Maecenas pharetra orci eu semper pharetra. Suspendisse vel elit semper, fringilla metus ac, pulvinar justo. Vestibulum nibh lacus, pellentesque non arcu vel, efficitur eleifend lorem. Duis ultrices bibendum orci, nec laoreet elit. In vulputate massa vel massa cursus gravida. Aliquam sed lacus pulvinar, imperdiet risus at, lacinia dolor. Maecenas pellentesque arcu mattis iaculis efficitur. Maecenas quis sem pulvinar, sodales neque eget, efficitur odio.",
      experiences: [
        {
          name: "Na Pali Coast",
          slug: "na-pali-coast",
    ...
    {
      name: "Nouvelle salle de repos",
      slug: "Nouvelle salle de repos",
      image: "jamaica.jpg",
      id: 4,
      description:
        "Suspendisse lobortis pharetra tempor. Cras eleifend ante sed arcu interdum, in bibendum enim ultricies. Integer rutrum quis risus at tempor. Maecenas facilisis, nisi vel pellentesque maximus, lectus felis malesuada purus, a pulvinar elit est quis turpis. Duis convallis purus quis finibus consequat. Pellentesque faucibus tincidunt augue non consequat. Donec fringilla at est sit amet blandit. Nunc at porttitor ligula. Fusce sed odio turpis.",
